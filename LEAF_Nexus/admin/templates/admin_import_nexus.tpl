...
<div class="margin-1rem-all">
    <span style="font-size: 18px; font-weight: bold">Import Nexus</span>
    <p>Batch import employees, supervisors, and position descriptions.</p>
    <div id="groupList"></div>
</div>

<div id="status" style="background-color: black; color: white; font-weight: bold; font-size: 140%"></div>

<div id="uploadBox" class="margin-1rem-all">
    <h4>Choose a Spreadsheet</h4>
    <p>The first row of the file must be headers for the columns.</p>
    <div>
        <input id="sheet_upload" type="file"></input>
    </div>
</div>

<div id="toggler" style="display: none" class="margin-1rem-all">
...
<div id="import_data_new_form" style="display: none;" class="margin-1rem-all">
    <h4>Create a Form</h4>
...
<div id="import_data_existing_form" style="display: none;" class="margin-1rem-all">
    <h4>Select a Form</h4>
                ...
                function(categoryID) {
                    ...
                    function makeIndicator() {
                        ...
                        if (formCreationIndex < indicatorTableRows.length) {
                            ...
                            function selectRowToAnswer(i) {
                                ...
                                function answerQuestions() {
                                    if (completed >= indicatorArray.length) {
                                        ...
                                        makeRequests(newCategoryID, requestData);
                            ...
                            for (var i = 1; i <= sheet_data.cells.length - 1; i++) {
                                selectRowToAnswer(i);
                            }
                        }
                    }
